...
The snippets below are very abbreviated examples. There are more---and more detailed---examples in `vignettes` as well as in the preprint for this package [(Beaton, 2020)](http://arxiv.org/abs/2010.14734).
